...
public class FcsCacheManager {
    ...
    final String FC_SOCIAL_CACHE_DIR = "media"+ File.separator+"apraise"+ File.separator+"AppraiseCachedImages";
    final String TEMP_CACHED_IMAGE = FC_SOCIAL_CACHE_DIR + File.separator + "TempCachedImages";
    ...
    public void init(Context context) {
        ...
        if (android.os.Environment.getExternalStorageState().equals(android.os.Environment.MEDIA_MOUNTED)) {
            ...
            cacheDir = new File(android.os.Environment.getExternalStorageDirectory(), FC_SOCIAL_CACHE_DIR);
